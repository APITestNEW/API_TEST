...
public class FE_test_bulk_flow_multiple_checks_1 {
	...
	String token;
 	...
 	public static String emailid = "prajaktapatil";
 	public static String password = "akshay";
 	public static String FromDate="2023-06-29";
 	public static String ToDate=today;
 	public static String tablename="Student_S_LT";
 	public static String NullCheckCol="SerNo";
 	public static String DuplicateCheckCol="SerNo";
 	public static String DateCheckCol="DOBB";
 	public static String VACheckCol="Sper";
 	public static String DistCheckCol1="Sper";
 	public static String DistCheckCol2="Fees";
		 ...
		 Response response = FE_conn_endpoints.conn();
			...
			public  void cr_template() throws InterruptedException
			{
			 Response response = FE_template_endpoints.createTemplate();
				...
				Response response = FE_validation_endpoints.searchValidation();
						System.out.println("-----------------------------assert start--------------------------");
						System.out.println("Response time is"+" "+ response.getTime()+"s");
						System.out.println("Status code is"+" "+ response.getStatusCode());
